...
class Runner():
    ...
    def __init__(self, *, env, model_list, sample_model_list,nsteps, gamma, lam):
        self.env = env
        self.model_list = model_list
        self.sample_model_list=sample_model_list
    ...
    def run(self,iTrainAgent):
        ...
        for _ in range(self.nsteps):
            ...
            for i in range(self.n_agent):
                if i!=iTrainAgent:
                    actModel=self.sample_model_list[i]
                else:
                    actModel=self.model_list[i]
                actions, values, states, neglogpacs = actModel.step(self.obs_list[i], S=self.states_list[i],
                                                                              M=self.dones[i])
